        ...
        <form onSubmit={handleLogin}>
            <div className="mb-7">
                ...
                <p className="text-gray-400">
                    ...
                    <a href="#" className="text-sm text-purple-700 hover:text-purple-700" onClick={() => switchView('register')}>
                        Regístrate
                    </a>
                </p>
            </div>
            <div className="space-y-6">
                <div>
                    <input
                        ...
                        type="email" // Asegúrate de especificar el tipo de input
                        value={email}
                ...
                <div className="flex items-center justify-between">
                    <div className="text-sm ml-auto">
                        <a href="#" className="text-purple-700 hover:text-purple-600" onClick={() => switchView('forgotPassword')}>
