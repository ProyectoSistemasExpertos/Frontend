            ...
            <div className="relative min-h-screen sm:flex sm:flex-row justify-center bg-transparent rounded-3xl shadow-xl">
                <div className="flex-col flex self-center lg:px-14 sm:max-w-4xl xl:max-w-md z-10">
                    <div className="self-start hidden lg:flex flex-col text-gray-300">
                        ...
                        <p className="pr-3 text-sm opacity-75">Lo que ronque el qlo</p>
                    </div>
                </div>
                <div className="flex justify-center self-center z-10">
                    <div className="p-12 bg-white mx-auto rounded-3xl w-96">
                        <div className="mb-7">
                            ...
                            <p className="text-gray-400">¿No tienes una cuenta? <a href="#" className="text-sm text-purple-700 hover:text-purple-700">Regístrate</a></p>
                        </div>
                        <div className="space-y-6">
                            ...
                            <div className="flex items-center justify-between">
                                <div className="text-sm ml-auto">
                                    <a href="#" className="text-purple-700 hover:text-purple-600">¿Olvidaste tu contraseña?</a>
                                </div>
                            </div>
                            <div>
